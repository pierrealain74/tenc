...
$header_classes = ['c27-main-header', 'header', "header-style-{$data['style']}", "header-width-{$data['width']}", "header-{$data['skin']}-skin", "header-scroll-{$data['scroll_skin']}-skin", 'header-scroll-hide'];
