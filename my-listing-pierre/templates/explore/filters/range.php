...
>
    <div v-if="location === 'primary-filter'" class="explore-head-search form-group radius">
        <i class="mi search"></i>
        <div class="mylisting-range-slider" behavior="<?php echo esc_attr( $filter->get_prop('behavior') ) ?>" data-value="<?php echo esc_attr( $filter->get_request_value() ) ?>" data-format-value="<?php echo $filter->get_prop('format_value') ? 'true' : 'false' ?>" data-min="<?php echo esc_attr( $filter->get_range_min() ) ?>" data-max="<?php echo esc_attr( $filter->get_range_max() ) ?>" data-step="<?php echo esc_attr( $filter->get_prop('step') ) ?>" data-type="<?php echo $filter->get_prop('option_type') === 'simple' ? 'single' : 'range' ?>">
