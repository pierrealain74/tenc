...
class Assets {
	...
	public function register_scripts() {
		...
		wp_register_script( 'mylisting-admin-user-roles', get_stylesheet_directory_uri() . '/assets/dist/admin/user-roles.js', ['jquery', 'vuejs'], \MyListing\get_assets_version(), true );
        ...
        wp_register_script( 'mylisting-explore', get_stylesheet_directory_uri() . '/assets/dist/explore.js', ['c27-main'], \MyListing\get_assets_version(), true );
	...
	public function enqueue_scripts() {
		...
		// wp_enqueue_script('', 'source', array('jquery'), 'version', false);
		wp_enqueue_script( 'c27-main', get_stylesheet_directory_uri() . '/assets/dist/frontend.new.js', ['mylisting-vendor'], \MyListing\get_assets_version(), true );
