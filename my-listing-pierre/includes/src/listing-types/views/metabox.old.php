	...
	<div class="tabs-content">
		<section v-if="currentTab === 'settings'" class="section">
			<div class="sub-tabs">
				...
				<nav-sub-item tab="settings" subtab="reviews" label="Reviews Ads"></nav-sub-item>
				<!-- <nav-sub-item tab="settings" subtab="reviews-profile" label="Reviews Profile"></nav-sub-item> -->
			...
			<?php //require locate_template( 'includes/src/listing-types/views/settings/reviews-profile.php' ) ?>
