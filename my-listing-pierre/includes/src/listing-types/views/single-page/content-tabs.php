<div class="tab-content full-width" v-if="currentSubTab == 'pages'">
	...
	--><div class="editor-column col-1-3">
		<div class="form-section mb10">
			...
			<div
				v-for="label, key in { main: 'Profile', comments: 'Reviews', reviews_profile: 'Reviews Profile', related_listings: 'Related Listings', store: 'Store', bookings: 'Bookings', custom: 'Custom' }"
