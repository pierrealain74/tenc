...
function validate_config( $new_config ) {
	...
	$config['lost_captcha'] = ! empty( $new_config['lost_captcha'] );
...
function get_preset_fields() {
	return [
		...
		'password_2' => new Profile_Fields\Password_Field( [
			'slug' => 'password_2',
		...
		'address' => new Profile_Fields\Text_Field( [
			'slug' => 'address',
			'label' => 'Address',
			'required' => true,
			'show_in_register_form' => true,
		...
		'post_code' => new Profile_Fields\Text_Field( [
			'slug' => 'post_code',
			'label' => 'Post Code',
			'required' => true,
			'show_in_register_form' => true,
		...
		'city' => new Profile_Fields\Text_Field( [
			'slug' => 'city',
			'label' => 'City',
			'required' => true,
			'show_in_register_form' => true,
		...
		'country' => new Profile_Fields\Text_Field( [
			'slug' => 'country',
			'label' => 'Country',
			'required' => true,
			'show_in_register_form' => true,
		...
		'phone_number' => new Profile_Fields\Number_Field( [
			'slug' => 'phone_number',
			'label' => 'Phone Number',
			'required' => true,
			'show_in_register_form' => true,
		...
		'html_field' => new Profile_Fields\Checkbox_Field( [
			'slug' => 'html_field',
			'label' => 'Acceptance',
			'required' => true,
			'show_in_register_form' => true,
...
function get_custom_fields() {
	...
	$fields = [];
	foreach ( (array) $fields_array as $fieldarr ) {
		$fieldclass = sprintf(
			'\MyListing\Src\User_Roles\Profile_Fields\%s_Field',
			c27()->file2class( $fieldarr['type'] )
		);
...
function get_field_types() {
	...
	$field_types = [
		...
		new Profile_Fields\Number_Field,
		new Profile_Fields\Checkbox_Field,
	];
