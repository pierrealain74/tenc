...
class Explore extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control( 'add_compare_button', [
			'label' => __( 'Add Compare Button', 'my-listing' ),
			'description' => __( 'Adds "Compare" button to listing preview cards.', 'my-listing' ),
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'default' => '',
			'label_on' => __( 'Yes', 'my-listing' ),
			'label_off' => __( 'No', 'my-listing' ),
	...
	protected function render( $instance = [] ) {
		c27()->get_section( 'explore', [
			...
			'add_compare_button' => 'yes' === $this->get_settings( 'add_compare_button' ),
